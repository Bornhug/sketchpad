...
class MultimodalAssistantAgent(MultimodalConversableAgent):
...
Reply "TERMINATE" in the end if you believe the user's initial task is completed. Otherwise, continue the conversation.
"""
